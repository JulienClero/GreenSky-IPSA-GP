...
<html>
    ...
    <body>
		...
		<div class="wrapper">
			...
			<div class='one_l'>
				<?php
					if($R1>35){echo'Votre score pour la phase conception est médiocre,</br>
						...
						Veillez à limiter au maximum l’utilisation de matériaux difficiles à recycler, ou rares.
						</br></br>
						Adhérer à des normes ISO. ';
					}

					elseif($R1>10){echo'Votre score pour la phase conception est correct,</br>
					...
					else{echo'Votre score pour la phase conception est bon,</br>
			...
			<div class='two_l'>
				<?php
					if($R2>35){echo'Votre score pour la phase chaine d’approvisionnement est médiocre,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes :</br>
						(nous vous recommandons fortement de les suivre étant donné votre faible implication écologique)
						</br></br>
					...
					elseif($R2>10){echo'Votre score pour la phase chaine d’approvisionnement est correct,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
						-Réfléchissez aussi au conditionnement de vos produits, utilisez plutôt le bois ou le métal afin de pouvoir les réutiliser voire les recycler.  ';
					}

					else{echo'Votre score pour la phase chaine d’approvisionnement est bon,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
			...
			<div class='three_l'>
				<?php
					if($R3>35){echo'Votre score pour la phase fabrication est médiocre,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes :</br>
						(nous vous recommandons fortement de les suivre étant donné votre faible implication écologique) 
						</br></br>
					...
					elseif($R3>10){echo'Votre score pour la phase fabrication est correct,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
						Améliorez le ratio de matière entrante/sortante 
						</br></br>
						Maximisez la réutilisation de l’eau et/ou son traitement 
						</br></br>
						Utilisez au maximum les énergies renouvelables ';
					}
			...
			<div class='four_l'>
				<?php
					if($R4>35){echo'Votre score pour la phase opération est médiocre,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes :</br>
						(nous vous recommandons fortement de les suivre étant donné votre faible implication écologique) 
						</br></br>
					...
					elseif($R4>10){echo'Votre score pour la phase opération est correct,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
						Veillez à limiter les déplacements lors de la maintenance. Cela passe par le fait de choisir un fournisseur dans un secteur proche et d’avoir une équipe qualifiée de réparateur disponible dans un périmètre réduit. ';
					}

					else{echo'Votre score pour la phase opération est bon,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
			...
			<div class='five_l'>
				<?php
					if($R5>35){echo'Votre score pour la phase recyclage est médiocre,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes :</br>
						(nous vous recommandons fortement de les suivre étant donné votre faible implication écologique)
						</br></br>
						- pensez à revaloriser au maximum vos déchets afin de leur donner une seconde vie.
						Si cela n’est pas possible, il convient alors de les recycler au plus haut niveau afin de réduire les pertes. ';
					}

					elseif($R5>10){echo'Votre score pour la phase recyclage est correct,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
					...
					else{echo'Votre score pour la phase recyclage est bon,</br>
						pour l’améliorer nous vous proposons les recommandations suivantes : 
						</br></br>
